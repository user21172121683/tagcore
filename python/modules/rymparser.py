...
class Rymparser(HTMLParser):
    ...
    def __init__(self):
        super().__init__()
        self.flags = {
            'album': False, 'album_name': False, 'date': False, 'rating': False,
            'label': False, 'ownership': False, 'genre_link': False, 'label_catalognr': False,
            'credited_name': False, 'artist': False, 'collab': False, 'tagcloud': False, 'tag': False
        }
        self.albums = []
    ...
    def handle_data(self, data: str):
        ...
        handlers = {
            ...
            'album_name': lambda: self._append('current_album_name', 'album_title', data),
